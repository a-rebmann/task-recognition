...
from taskrecognition.taskcategorization.clusterer.microcluster import MicroCluster
...
class DenStream:
    ...
    def fit_predict(self, X, y=None, sample_weight=None, num_current_features=70):
        """
        ...
        p_micro_cluster_weights = [p_micro_cluster.weight() for p_micro_cluster in
                                   self.p_micro_clusters]
        dbscan = DBSCAN(eps=min(num_current_features*0.0725, 5), algorithm='brute')
